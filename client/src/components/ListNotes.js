...
import {Container, Nav, Navbar, ListGroup, Modal, Button, InputGroup, FormControl} from 'react-bootstrap';
                ...
                <Container style={{margin: '3em'}}>
                    <ListGroup>
                        {titles.map((title, key)=>(
                            <ListGroup.Item key={key} action onClick={()=>this.handleClick(title)}>
                            {title}
                            </ListGroup.Item>
                        ))}
                    </ListGroup>
                    <Modal show={this.state.show} onHide={this.handleClose}>
                            ...
                            <Modal.Body>
                                ...
                                <InputGroup className="mb-3">
                                    ...
                                    <FormControl id="basic-url" onChange={this.handleKeyChange} value={this.state.hashKey} aria-describedby="basic-addon3" />
                                </InputGroup>
                                </>}
                            </Modal.Body>
                            <Modal.Footer>
